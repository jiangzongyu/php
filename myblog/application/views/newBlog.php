...
<ul>
	<li class="caption">博客管理	
		<ol>
			<li class="current"><a href="blog/newBlog">发表博客</a></li>
    ...
    <div id="AdminContent">
<div class="MainForm">
<form id="BlogForm" action="blog/save_blog" method="POST">
<input id="hdn_blog_id" name="draft" value="0" type="hidden">
  ...
  <tr>
	...
	?>
	  <option selected="selected" name="catalog" value="<?php echo $catalog->NAME;?>"><?php echo $catalog->NAME;?></option>
	<?php } ?>
		</select>
	<a href="catalog" onclick="return confirm('是否放弃当前编辑进入分类管理？');">分类管理»</a>
	</td>
  </tr>
  <tr><td class='t'>内容（必填） 
