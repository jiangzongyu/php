...
<ul>
	<li class="caption">博客管理	
		<ol>
			...
			<li class="current"><a href="comment/manage_comment">博客评论管理</a></li>
		</ol>
	</li>
</ul>
</div>
...
<div class="MainForm BlogCommentManage">
  ...
  <ul>
		...
		<span class="comment">
		<div class="user"><b><?php echo $comment->NAME; ?></b> 评论了 <a href="viewPost_comment.htm" target="_blank"><?php echo $comment->TITLE; ?></a></div>
		<div class="content"><p><?php echo $comment->COMMENT; ?></p></div>
		<div class="opts">
