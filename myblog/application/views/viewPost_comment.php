...
<div class="Blog">
  ...
  <div class="BlogContent TextContent"><?php echo $blogs->CONTENT; ?></div>
...
<?php foreach ($comments as $comment) {
	...
	<div class='body'>
		...
		<div class='title'>
			...
			<?php echo $comment->NAME; ?> 发表于 <?php echo $comment->ADD_TIME; ?></div>

		<div class='post'><?php echo $comment->COMMENT; ?></div>
...
<?php } ?>
  ...
  <div class="CommentForm">
    <a name="postform"></a>
    <form id="form_comment" action="comment/add_comment" method="POST"> 
    
    <input type="hidden" value="<?php echo $blogs->BLOG_ID; ?>" name="id"/> 
...
<div class="BlogMenu"><div class="RecentBlogs SpaceModule">
	<strong>最新博文</strong><ul>
    		...
    		<?php } ?>
			<li class="more"><a href="blog/logined">查看所有博文»</a></li>
    </ul>
</div>
