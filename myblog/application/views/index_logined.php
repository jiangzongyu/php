...
<?php $login_user=$this->session->userdata("login_user");
    ...
    <div id="lnks">
		<strong><?php echo $login_user->NAME; ?>的博客</strong>
...
<ul>
  ...
  <li class="Blog" id="blog_24027">
	<h2 class="BlogAccess_true BlogTop_0"><a href="comment?wid=<?php echo $myblog->BLOG_ID;?>"><?php echo $myblog->TITLE;?></a></h2>
	<div class="outline">
	  <span class="time">发表于 <?php echo $myblog->ADD_TIME;?></span>
	  <span class="catalog">分类: <a href="#"><?php echo $myblog->CATALOGNAME;?></a></span>
	  <span class="stat">统计: 1评/<?php echo $myblog->CLICK_RATE;?>阅</span>
		...
		<div class="TextContent" id="blog_content_24027">
				<p><?php echo $myblog->CONTENT;?></p>
		<div class="fullcontent"><a href="comment?wid=<?php echo $myblog->BLOG_ID;?>">阅读全文...</a></div>
			</div>
	  </li>
  		<?php } ?>
</ul>
...
<div class="BlogMenu"><div class="admin SpaceModule">
  ...
  <ul class="LinkLine">
	<li><a href="blog/newBlog">发表博客</a></li>
			<li><a href="catalog">博客分类管理</a></li>
	<li><a href="blog/do_blog">文章管理</a></li>
	<li><a href="comment/manage_comment">网友评论管理</a></li>
  </ul>
</div>
