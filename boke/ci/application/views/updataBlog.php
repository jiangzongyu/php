...
<div id="OSC_Screen"><!-- #BeginLibraryItem "/Library/OSC_Banner.lbi" -->
    ...
    <div id="OSC_Content">
        <div id="AdminScreen">
            ...
            <div id="AdminMenu"><ul>
                ...
                <ul>
                    <li class="caption">博客管理
                        <ol>
                            <li class="current"><a href="blogc/newBlog">发表博客</a></li>
                            <li><a href="blogc/blogCatalog">博客设置/分类管理</a></li>
            ...
            <div id="AdminContent">
                <div class="MainForm">
                    <form id="BlogForm" action="blogc/do_updata" method="POST">

                        <table>
                            <tbody><tr><td class="t">标题（必填）</td></tr>
                            <tr>
                                <td>
                                    <input name="blog_id" value="<?php echo $blog->BLOG_ID?>" type="hidden">
		...
		<strong>原文链接: </strong><input id="t_origin_url" name="origin_url" class="TEXT" size="50" type="text">
                            ...
                            <tr class="submit">
                                <td>
                                    <input value=" 修改 " class="BUTTON SUBMIT" type="submit">
