...
<ul>
	<li class="caption">博客管理	
		<ol>
			...
			<li class="current"><a href="blogc/blogCatalog">博客设置/分类管理</a></li>
...
<form id="CatalogForm" action="bolgc/do_blogCatalog" method="post">
    <h3> 添加博客分类 </h3>
...
<table cellpadding="1" cellspacing="1">
	...
	<tr id="catalog_92334">
		...
		<!-- ctd class="name"><a href="editCatalog.htm" title="点击修改博客分类"></a></td> -->
		<td class="num">3</td>
		<td class="opts">
